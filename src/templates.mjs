import { BUILD_DATE, GOOGLE_ADSENSE_ACCOUNT, NAVER_SITE_VERIFICATION, SITE_NAME, localeOrder, locales, pagePath, pages } from './config.mjs';
...
function headMarkup(siteUrl, locale, pageKey, extra = {}) {
  ...
  return `
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover">${adsenseMeta}${naverMeta}
...
export function renderLanguageHub(siteUrl) {
  ...
  const naverMeta = NAVER_SITE_VERIFICATION ? `<meta name="naver-site-verification" content="${NAVER_SITE_VERIFICATION}">` : '';
  return `<!doctype html><html lang="en"><head>
    <meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover">${adsenseMeta}${naverMeta}<meta name="theme-color" content="#181a27">
    <title>FIVEGRID | Gomoku · 오목 · 五子棋</title><meta name="description" content="설치 없이 즐기는 무료 온라인 AI 오목 게임. 3단계 난이도 대국과 오목 규칙, 필승 전략 학습을 제공합니다.">
    ...
    <meta property="og:title" content="FIVEGRID | Gomoku · 오목 · 五子棋"><meta property="og:description" content="설치 없이 즐기는 무료 온라인 AI 오목 게임. 3단계 난이도 대국과 오목 규칙, 필승 전략 학습을 제공합니다."><meta property="og:image" content="${siteUrl}/assets/og-cover.png"><meta property="og:url" content="${siteUrl}/"><meta property="og:type" content="website">
